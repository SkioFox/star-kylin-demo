...
本离线包交付 `kylin-sky-demo 0.2.1-5`，用于已采集的客户基线：银河麒麟桌面操作系统 V10 SP1（`PROJECT_CODENAME=V10SP1`、`KYLIN_RELEASE_ID=2503`）、`amd64`、glibc `2.31-0kylin9.1k22.0`。
...
```bash
sha256sum -c kylin-sky-demo-offline-amd64-0.2.1-5-20260730.1.tar.gz.sha256
tar -xzf kylin-sky-demo-offline-amd64-0.2.1-5-20260730.1.tar.gz
cd kylin-sky-demo-offline-amd64-0.2.1-5-20260730.1
sudo ./install.sh
